![Contributte Doctrine MongoDB](https://heatbadger.now.sh/github/readme/contributte/doctrine-mongodb/)
...
|--------|---------|----------|-------|---------|
| dev    | `^0.3`  | `master` | 3.1+  | `>=8.2` |
| stable | `^0.2`  | `master` | 3.0+  | `>=7.4` |
...
<a href="https://github.com/solcik">
    <img width="80" height="80" src="https://avatars.githubusercontent.com/solcik">
</a>
